...
export class VideoPage {
  ...
  urll:any;
  first:any;
  constructor(private sanitizer: DomSanitizer,public platform:Platform,public navCtrl: NavController,public navParams: NavParams,private httpstorage:HttpStorage,private transfer: FileTransfer, private file: File) {
    this.playbackRate=1;
    this.seg="s1";
